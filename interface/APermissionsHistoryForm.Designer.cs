namespace Kantot
{
    partial class APermissionsHistoryForm
    {
        /// <summary>
        ...
        private void InitializeComponent()
        {
            ...
            tsTopBar.Items.AddRange(new ToolStripItem[] { btnMainMenu, toolStripSeparator5, tbSearch, btnSearchActive, toolStripSeparator6 });
            ...
            dgvProducts.Columns.AddRange(new DataGridViewColumn[] { sicilno, adisoyadi, departman, turadi, bastar, bittar, aciklama, izindurumu, durumnot });
            ...
            durumnot.HeaderText = "Durum Notu";
            durumnot.Name = "durumnot";
            durumnot.ReadOnly = true;
            // 
            // APermissionsHistoryForm
            // 
            ...
            MaximizeBox = false;
            MinimizeBox = false;
            Name = "APermissionsHistoryForm";
            ShowIcon = false;
            ShowInTaskbar = false;
            StartPosition = FormStartPosition.CenterScreen;
            Text = "PermissionsHistoryForm";
